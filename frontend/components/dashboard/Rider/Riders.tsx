                ...
                <main className="flex-1 flex flex-col overflow-y-auto gap-4 lg:gap-6 p-3 lg:p-6">
                    ...
                    <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
                        <div className="flex flex-col items-start justify-start gap-2">
                            ...
                            <p className="text-sm lg:text-lg font-normal text-black">Manage bike rental Riders and their Payment mandates (Weekly)</p>
                        </div>
                            ...
                            <table className="w-full border-collapse-separate min-w-[800px]">
                                <thead className='bg-[#020202] border border-[#FEFDFF]'>
                                    <tr className="border-b border-gray-200">
                                        ...
                                        <th className="text-center py-2 lg:py-3 px-2 lg:px-4 font-normal border border-r border-[#FFFFFF] text-white text-xs lg:text-sm">Amount (Weekly)</th>
