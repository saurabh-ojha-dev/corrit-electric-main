...
import { paymentHistoryData } from '@/constants/data'
...
const PaymentHistory = () => {
    ...
    const handlePhonepeOrderStatusCheck = (paymentId: string) => {
                                        ...
                                        <tr>
                                            <td colSpan={6} className="px-2 lg:px-3 py-3 lg:py-4 bg-[#F5F5F5]">
                                                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border border-[#0000003D] rounded-xl py-2 lg:py-3 px-3 lg:px-4 gap-2 lg:gap-0">
                                                    ...
                                                    <button
                                                        type='button'
                                                        className="inline-flex items-center gap-1 lg:gap-2 bg-[#0063B0] text-white p-1.5 lg:p-2 rounded-xl hover:bg-blue-700 transition-colors cursor-pointer text-xs lg:text-sm"
                                                        onClick={() => handlePhonepeOrderStatusCheck(payment.id)}
                                                    >
                                                        <RefreshCw className="w-3 h-3 lg:w-4 lg:h-4" />
                                                        <span>Check Phonepe</span>
                                                    </button>
                                                </div>
                                                {phonepeOrderStatus === payment.id && (
                                                    <>
                                                        <div className="mt-2 bg-white flex flex-col rounded-xl py-2 lg:py-3 px-3 lg:px-4">
                                                            ...
                                                            <span className="text-xs lg:text-base font-normal text-[#6C757D]">Payment successful! UTR: 521023162637</span>
                                                            <p className="text-xs lg:text-base font-normal text-[#020202] flex flex-col sm:flex-row sm:justify-between gap-1">
                                                                ...
                                                                <span>Order ID: OMO2507281505519054391297</span>
                                                            </p>
                                                        </div>
                                                        ...
                                                        >
                                                            ...
                                                            <span className="text-xs lg:text-base font-normal text-[#0063B0]">From: 7/29/2025, 3:05:52 PM</span>
                                                            <span className="text-xs lg:text-base font-normal text-[#0063B0]">To: 7/30/2025, 3:05:51 PM</span>
                                                        </div>
                                                    </>
                                                )}
                                            </td>
