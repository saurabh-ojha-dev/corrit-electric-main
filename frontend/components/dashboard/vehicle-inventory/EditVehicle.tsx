...
interface EditVehicleProps {
    ...
    vehicle: any; // Single vehicle object instead of array
...
const EditVehicle: React.FC<EditVehicleProps> = ({ isModalOpen, setIsModalOpen, vehicle, onVehicleUpdated }) => {
    ...
    useEffect(() => {
        if (isModalOpen && vehicle) {
            setFormData({
                vehicleName: vehicle.vehicleName || '',
                vehicleRegistrationNumber: vehicle.vehicleRegistrationNumber || '',
                vehicleChassisNumber: vehicle.vehicleChassisNumber || '',
                vehicleMotorNumber: vehicle.vehicleMotorNumber || '',
                iotImeiNumber: vehicle.iotImeiNumber || '',
                controllerNumber: vehicle.controllerNumber || '',
            });
        }
    }, [isModalOpen, vehicle]);
            ...
            <div ref={modalRef} className="bg-white rounded-2xl lg:rounded-3xl p-4 lg:p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex justify-between items-start mb-4 lg:mb-6">
                    <div className="flex justify-start items-start gap-3 lg:gap-4">
                        ...
                        <div>
                            <h2 className="text-lg lg:text-xl font-semibold text-black">Edit Vehicle</h2>
                            <p className="text-xs lg:text-sm text-gray-600">Update the vehicle details.</p>
                        </div>
                    </div>
                    <button
                        type='button'
                        ...
                        >
                            {isSubmitting ? (
                                ...
                                <>
                                    ...
                                    <span className="whitespace-nowrap">Update Vehicle</span>
                                </>
                            )}
                        </button>
                        <button
