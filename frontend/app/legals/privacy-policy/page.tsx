                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                <div>
                                    <h3 className="mb-2 flex items-center gap-2 text-sm font-semibold text-slate-900">
                                        <User2 className="h-4 w-4 text-sky-600" /> Personal
                                    </h3>
                                ...
                                <div>
                                    <h3 className="mb-2 flex items-center gap-2 text-sm font-semibold text-slate-900">
                                        <Bike className="h-4 w-4 text-sky-600" /> Rental
                                    </h3>
                                    <ul className="space-y-2 text-sm">
                                ...
                                <div>
                                    <h3 className="mb-2 flex items-center gap-2 text-sm font-semibold text-slate-900">
                                        <Cpu className="h-4 w-4 text-sky-600" /> Technical
                                    </h3>
                                    <ul className="space-y-2 text-sm">
                                        <li>IP address</li>
                                        <li>Browser type</li>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div className="rounded-xl border border-slate-200 p-4">
                                    <h3 className="mb-3 inline-flex items-center gap-2 text-sm font-semibold text-slate-900">
                                        <BadgeCheck className="h-4 w-4 text-sky-600" /> Service
                                        Delivery
                                    </h3>
                                    <ol className="space-y-2 text-sm">
                                        <li className="flex items-start gap-2">
                                            <span className="mt-0.5 inline-block h-5 w-5"><CheckCircle2 className="h-5 w-5 text-sky-600" /></span>
                                ...
                                <div className="rounded-xl border border-slate-200 p-4">
                                    <h3 className="mb-3 inline-flex items-center gap-2 text-sm font-semibold text-slate-900">
                                        <BadgeCheck className="h-4 w-4 text-sky-600" /> Business
                                        Operations
                                    </h3>
                                    <ol className="space-y-2 text-sm">
                                        <li className="flex items-start gap-2">
